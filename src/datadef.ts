// To parse this data:
//
//   import { Convert, Datadef } from "./file";
//
//   const datadef = Convert.toDatadef(json);
//
...
export interface Entities {
    ...
    loader:                                Entity;
    "fast-loader":                         Entity;
    "express-loader":                      Entity;
    "burner-inserter":                     BurnerEntity;
    inserter:                              Entity;
    "long-handed-inserter":                Entity;
    "fast-inserter":                       Entity;
    "filter-inserter":                     Entity;
    "stack-inserter":                      Entity;
    "stack-filter-inserter":               Entity;
    ...
    "logistic-chest-active-provider":      Entity;
    "logistic-chest-passive-provider":     Entity;
    "logistic-chest-storage":              Entity;
    "logistic-chest-buffer":               Entity;
    ...
    "electric-mining-drill":               PumpingEntity;
    "offshore-pump":                       Entity;
    pumpjack:                              PumpingEntity;
    ...
    "tree-07":                             Entity;
    "tree-06":                             Entity;
    "tree-06-brown":                       Entity;
    "tree-09-brown":                       Entity;
    "tree-09-red":                         Entity;
    "tree-08":                             Entity;
    "tree-08-brown":                       Entity;
    "tree-08-red":                         Entity;
    "dead-dry-hairy-tree":                 Entity;
    "dead-grey-trunk":                     Entity;
    "dead-tree-desert":                    Entity;
    "dry-hairy-tree":                      Entity;
    "dry-tree":                            Entity;
    "rock-huge":                           Entity;
    "rock-big":                            Entity;
    "small-biter-corpse":                  Entity;
    "medium-biter-corpse":                 Entity;
    "behemoth-biter-corpse":               CorpseEntity;
    "big-biter-corpse":                    CorpseEntity;
    "biter-spawner-corpse":                Entity;
    "small-spitter-corpse":                Entity;
    "medium-spitter-corpse":               Entity;
    "big-spitter-corpse":                  Entity;
    "behemoth-spitter-corpse":             CorpseEntity;
    "spitter-spawner-corpse":              Entity;
    "small-worm-corpse":                   Entity;
    "medium-worm-corpse":                  Entity;
    "big-worm-corpse":                     Entity;
    "small-remnants":                      Entity;
    "medium-remnants":                     Entity;
    "big-remnants":                        BigRemnants;
    "straight-rail-remnants":              Entity;
    "curved-rail-remnants":                Entity;
    "small-scorchmark":                    Entity;
    "tree-01-stump":                       Entity;
    "tree-02-stump":                       Entity;
    "tree-03-stump":                       Entity;
    "tree-04-stump":                       Entity;
    "tree-05-stump":                       Entity;
    "tree-06-stump":                       Entity;
    "tree-07-stump":                       Entity;
    "tree-08-stump":                       Entity;
    "tree-09-stump":                       Entity;
    "wall-remnants":                       Entity;
    "sand-rock-big":                       Entity;
    "big-ship-wreck-1":                    BigShipWreck;
    "big-ship-wreck-2":                    BigShipWreck;
    "big-ship-wreck-3":                    BigShipWreck;
    "medium-ship-wreck":                   Entity;
    "small-ship-wreck":                    Entity;
    "small-biter":                         Entity;
    "medium-biter":                        Entity;
    "big-biter":                           EnemyEntity;
    "behemoth-biter":                      EnemyEntity;
    "small-spitter":                       Entity;
    "small-worm-turret":                   Entity;
    "medium-spitter":                      Entity;
    "medium-worm-turret":                  Entity;
    "behemoth-spitter":                    EnemyEntity;
    "big-spitter":                         Entity;
    "big-worm-turret":                     Entity;
    "biter-spawner":                       Entity;
    "spitter-spawner":                     Entity;
    market:                                Entity;
    defender:                              Entity;
    distractor:                            Entity;
    destroyer:                             Entity;
    "acid-projectile-purple":              Projectile;
    "acid-splash-purple":                  Projectile;
    "artillery-cannon-muzzle-flash":       Projectile;
    "artillery-flare":                     ArtilleryFlare;
    "artillery-projectile":                Projectile;
    "atomic-bomb-wave":                    Projectile;
    "atomic-rocket":                       Projectile;
    "big-artillery-explosion":             Projectile;
    "big-explosion":                       Projectile;
    "big-ship-wreck-grass":                Entity;
    "blood-explosion-big":                 Entity;
    "blood-explosion-huge":                Entity;
    "blood-explosion-small":               Entity;
    "blood-fountain":                      Entity;
    "blood-fountain-big":                  Entity;
    "blood-particle":                      Entity;
    "blue-laser":                          Entity;
    "branch-particle":                     Entity;
    "brown-asterisk":                      Entity;
    "brown-cane-cluster":                  Entity;
    "brown-cane-single":                   Entity;
    "brown-carpet-grass":                  Entity;
    "brown-coral-mini":                    Entity;
    "brown-fluff":                         Entity;
    "brown-fluff-dry":                     Entity;
    "brown-hairy-grass":                   Entity;
    "cannon-projectile":                   Entity;
    "character-corpse":                    Entity;
    "cliff-explosives":                    Entity;
    "cluster-grenade":                     Entity;
    "coal-particle":                       Entity;
    "copper-ore-particle":                 Entity;
    "deconstructible-tile-proxy":          Entity;
    "defender-capsule":                    Entity;
    "destroyer-capsule":                   Entity;
    "distractor-capsule":                  Entity;
    "dummy-flame-thrower-explosion":       Entity;
    "electric-beam":                       Entity;
    "electric-beam-no-sound":              Entity;
    "entity-ghost":                        Entity;
    explosion:                             Entity;
    "explosion-gunshot":                   Entity;
    "explosion-gunshot-small":             Entity;
    "explosion-hit":                       Entity;
    "explosion-remnants-particle":         Entity;
    "explosive-cannon-projectile":         Entity;
    "explosive-rocket":                    Entity;
    "explosive-uranium-cannon-projectile": Entity;
    "fake-selection-box-2x2":              Entity;
    "fire-flame":                          Entity;
    "fire-flame-on-tree":                  Entity;
    "fire-sticker":                        Entity;
    "flamethrower-fire-stream":            Entity;
    "flying-text":                         Entity;
    garballo:                              Entity;
    "garballo-mini-dry":                   Entity;
    "green-asterisk":                      Entity;
    "green-bush-mini":                     Entity;
    "green-carpet-grass":                  Entity;
    "green-coral-mini":                    Entity;
    "green-hairy-grass":                   Entity;
    "green-pita":                          Entity;
    "green-pita-mini":                     Entity;
    "green-small-grass":                   Entity;
    grenade:                               Entity;
    "ground-explosion":                    Entity;
    "handheld-flamethrower-fire-stream":   Entity;
    "iron-ore-particle":                   Entity;
    "item-on-ground":                      Entity;
    "item-request-proxy":                  Entity;
    laser:                                 Entity;
    "laser-bubble":                        Entity;
    "leaf-particle":                       Entity;
    "massive-explosion":                   Entity;
    "medium-explosion":                    Entity;
    "orange-arrow-with-circle":            Entity;
    "orange-coral-mini":                   Entity;
    "piercing-shotgun-pellet":             Entity;
    "poison-capsule":                      Entity;
    "poison-cloud":                        Entity;
    "railgun-beam":                        Entity;
    "red-asterisk":                        Entity;
    rocket:                                Entity;
    ...
    "root-A":                              Entity;
    "root-B":                              Entity;
    "shell-particle":                      Entity;
    "shotgun-pellet":                      Entity;
    "slowdown-capsule":                    Entity;
    "slowdown-sticker":                    Entity;
    "small-ship-wreck-grass":              Entity;
    "smoke-for-migration":                 Entity;
    "stone-particle":                      Entity;
    "stun-sticker":                        Entity;
    "tank-flamethrower-fire-stream":       Entity;
    "tile-ghost":                          Entity;
    "tutorial-flying-text":                Entity;
    "uranium-cannon-explosion":            Entity;
    "uranium-cannon-projectile":           Entity;
    "uranium-cannon-shell-explosion":      Entity;
    "water-splash":                        Entity;
    "wooden-particle":                     Entity;
    "crude-oil":                           Entity;
    "iron-ore":                            Entity;
    "copper-ore":                          Entity;
    "uranium-ore":                         Entity;
    ...
    stone:                                 Entity;
    "blue-chest":                          Entity;
    "hidden-electric-energy-interface":    Entity;
    "red-chest":                           Entity;
}
...
export interface MovingEntityFlags {
    "placeable-neutral"?:        boolean;
    "placeable-off-grid"?:       boolean;
...
export interface PumpingEntity {
    name:                             string;
    type:                             string;
    flags:                            Flags3;
    order:                            string;
...
export interface Items {
    ...
    "storage-tank":                     Item;
    "transport-belt":                   Item;
    "fast-transport-belt":              Item;
    "express-transport-belt":           Item;
    "underground-belt":                 Item;
    "fast-underground-belt":            Item;
    "express-underground-belt":         Item;
    splitter:                           Item;
    "fast-splitter":                    Item;
    "express-splitter":                 Item;
    loader:                             Coin;
    "fast-loader":                      Coin;
    "express-loader":                   Coin;
    "burner-inserter":                  Item;
    inserter:                           Item;
    "long-handed-inserter":             Item;
    "fast-inserter":                    Item;
    "filter-inserter":                  Item;
    "stack-inserter":                   Item;
    "stack-filter-inserter":            Item;
    "small-electric-pole":              Item;
    "medium-electric-pole":             Item;
    "big-electric-pole":                Item;
    substation:                         Item;
    pipe:                               Item;
    "pipe-to-ground":                   Item;
    pump:                               Item;
    ...
    "train-stop":                       Item;
    "rail-signal":                      Item;
    "rail-chain-signal":                Item;
    locomotive:                         Item;
    "cargo-wagon":                      Item;
    "fluid-wagon":                      Item;
    "artillery-wagon":                  Item;
    car:                                Item;
    tank:                               Item;
    "small-plane":                      Coin;
    "logistic-robot":                   Item;
    "construction-robot":               AdvancedCircuit;
    "logistic-chest-active-provider":   Item;
    "logistic-chest-passive-provider":  Item;
    "logistic-chest-storage":           Item;
    "logistic-chest-buffer":            Item;
    "logistic-chest-requester":         Item;
    roboport:                           Item;
    "small-lamp":                       Item;
    "red-wire":                         Item;
    "green-wire":                       Item;
    "arithmetic-combinator":            Item;
    "decider-combinator":               Item;
    "constant-combinator":              Item;
    "power-switch":                     Item;
    "programmable-speaker":             Item;
    ...
    "heat-exchanger":                   Item;
    "heat-pipe":                        Item;
    "burner-mining-drill":              Item;
    "electric-mining-drill":            Item;
    "offshore-pump":                    Item;
    pumpjack:                           Item;
    "stone-furnace":                    Item;
    "steel-furnace":                    Item;
    "electric-furnace":                 Item;
    "assembling-machine-1":             Item;
    "assembling-machine-2":             Item;
    "assembling-machine-3":             Item;
    "oil-refinery":                     Item;
    "chemical-plant":                   Item;
    centrifuge:                         Item;
    lab:                                Item;
    ...
    grenade:                            Item;
    "cluster-grenade":                  Item;
    "poison-capsule":                   Item;
    "slowdown-capsule":                 Item;
    "defender-capsule":                 Item;
    "distractor-capsule":               Item;
    "destroyer-capsule":                Item;
    "discharge-defense-remote":         Item;
    "artillery-targeting-remote":       Item;
...
export module Convert {
    export function toDatadef(json: string): Datadef {
        return cast(JSON.parse(json), O("Datadef"));
    }

    export function datadefToJson(value: Datadef): string {
    ...
    const typeMap: any = {
        ...
        "BigShipWreckGrassGroup": [
            EntityGroup.Combat,
            EntityGroup.Enemies,
            EntityGroup.Environment,
            EntityGroup.Logistics,
            EntityGroup.Other,
            EntityGroup.Production,
        ],
