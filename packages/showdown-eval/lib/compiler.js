...
function createCompiler(readFile, otherFiles) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            next = files.pop();
                            return [4 /*yield*/, readFile(next)];
                        case 2:
                            content = _a.sent();
                            if (content === undefined)
                                throw new Error("Failed to load '" + next + "'");
                            host.addFile(next, content);
                            return [2 /*return*/, loadNextFile()];
                    }
                });
            });
        }
        ...
        return __generator(this, function (_a) {
            host = createHost();
            files = ['static/lib.d.ts'].concat(otherFiles);
            return [2 /*return*/, loadNextFile()];
        });
    });
}
...
function createHost() {
    var libFileName = "static/lib.d.ts";
    var lookup = {};
    var rootNames = [];
    var compilerOpts = {};
